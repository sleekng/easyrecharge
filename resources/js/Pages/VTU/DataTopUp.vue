        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-8 overflow-y-auto flex w-full flex-col justify-center items-center  sm:rounded-lg ">
                ...
                <div class=" mt-10 text-center">
                    <div>
                        <span class="font-bold text-primarycolor">Data</span>
                    </div>
                    <div>
                        <span>Join thousands of satisfied users who trust <span class=" text-primarycolor">Easy</span>Recharge.</span>
                    </div>
                        ...
                        <form @submit.prevent="submit">
                            <div>
                                ...
                                <div class=" grid grid-cols-5 gap-2 justify-items-center mt-4">
                                    <div class=" border-primarycolor border-2 shadow-md cursor-pointer w-20 h-20 flex justify-center relative items-center overflow-hidden rounded-md"> <img src="/storage/img/mtn.png" alt="">
                                    <input type="radio" class=" absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer z-40" name="network">
                                    </div>
                                    <div class="border shadow-md cursor-pointer w-20 h-20 flex justify-center relative items-center overflow-hidden rounded-md"> <img src="/storage/img/glo.png" alt="">
                                    <input type="radio" class=" absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer z-40" name="network">
                                    </div>
                                    <div class="border shadow-md cursor-pointer w-20 h-20 flex justify-center relative items-center overflow-hidden rounded-md"> <img src="/storage/img/9mobile.png" alt="">
                                    <input type="radio" class=" absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer z-40" name="network">
                                    </div>
                                    <div class="border shadow-md cursor-pointer w-20 h-20 flex justify-center relative items-center overflow-hidden rounded-md"> <img src="/storage/img/airtel.png" alt="">
                                    <input type="radio" class=" absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer z-40" name="network">
                                    </div>
                                    <div class="border shadow-md cursor-pointer w-20 h-20 flex justify-center relative items-center overflow-hidden rounded-md"> <img src="/storage/img/spectranet.png" alt="">
                                    <input type="radio" class=" absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer z-40" name="network">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 w-full">
                                <text-input v-model="form.first_name" class="w-full">
                                    <template #inputLable> Recievers phone number </template>
                                </text-input>
                                <InputError class="mt-2" :message="form.errors.first_name" />
                            </div>
                             <div class="mt-4 w-full">
